...
int main(int argc, char *argv[])
{
    ...
    *set4 << 211 << 212 << 399 << 399 << 211 << 320;
    ...
    chart->setAnimationOptions(QChart::SeriesAnimations); //toate animatiile; alte optiuni pt animatii: NoAnimation, GridAxisAnimations, SeriesAnimations
    ...
    pal.setColor(QPalette::Text, QRgb(0x04476e));
    qApp->setPalette(pal);
